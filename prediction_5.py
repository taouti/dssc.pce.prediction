...
CONFIG = {
    # Input Directories
    'DFT_OUTPUT_DIR': './outputs_LDA_ethanol',
    'MOL_DIR': './mol_LDA_ethanol',

    # Input Files
    'EXPERIMENTAL_DATA': 'dyes_experimental_dataset.xlsx',

    # Output Files
    'DFT_DATASET': 'dyes_DFT_LDA_eth_dataset.xlsx',
    'COMPREHENSIVE_RESULTS': 'PCE_results_LDA_eth.xlsx',
    'MODEL_OUTPUT': 'pce_prediction_model_LDA_eth.joblib',
    'FEATURE_IMPORTANCE': 'feature_importance_LDA_eth.xlsx',
